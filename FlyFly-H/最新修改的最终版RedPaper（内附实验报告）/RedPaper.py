...
while a == True:
    ...
    if mygold1.rect.top>550:#判断红包是否着地，一但着地，游戏结束
        loadgameover(scorenum,highscore)
        a = False
    if mygold2.rect.top>550:#判断红包是否着地，一但着地，游戏结束
        loadgameover(scorenum,highscore)
        a = False
    if mygold3.rect.top>550:#判断红包是否着地，一但着地，游戏结束
        loadgameover(scorenum,highscore)
        a = False
    if mygold4.rect.top>550:#判断红包是否着地，一但着地，游戏结束
        loadgameover(scorenum,highscore)
        a = False
    if mygold5.rect.top>550:#判断红包是否着地，一但着地，游戏结束
        loadgameover(scorenum,highscore)
        a = False
